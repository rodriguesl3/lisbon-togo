...
class StationsBloc extends BlocBase {
  ...
  Observable<List<LineModel>> get getStations {
    if (StationsBloc.initialData ==
        LatLng(_currentLocationController.value.latitude,
            _currentLocationController.value.longitude))
      return null;
    else
      return _stationsController.stream.asyncMap((station) =>
